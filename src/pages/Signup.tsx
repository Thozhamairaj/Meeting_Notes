    ...
    return (
        <div className="min-h-screen bg-slate-950 text-white flex flex-col items-center justify-center px-4 py-12">
            ...
            <div className="relative mb-6 flex rounded-xl border border-white/10 bg-white/5 p-1">
                <div className="absolute inset-y-1 right-1 w-[calc(50%-4px)] rounded-lg bg-cyan-500 transition-all duration-300" />
                <Link
                    to="/auth"
                ...
                <span className="relative z-10 px-8 py-2 text-sm font-semibold text-slate-950">Create account</span>
            </div>
